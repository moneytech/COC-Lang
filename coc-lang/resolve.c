...
ResolvedExpr resolve_expr_binary(Expr *expr) {
    ...
    if (left.type != type_int) {
        fatal("left operand of + must be an int");
    }
...
void resolve_test(void) {
    ...
    sys_global_type(str_intern("void"), type_void);
    sys_global_type(str_intern("char"), type_char);
    sys_global_type(str_intern("int"), type_int);
    sys_global_type(str_intern("float"), type_float);
